...
export default function BentoGrid() {
  return (
    <div className="hidden xl:px-48 lg:grid grid-cols-1 grid-rows-12 lg:grid-cols-4 lg:grid-rows-6 bg-gray-50 p-8 gap-4 py-24">
      {/* Bloque principal con visión */}
      <div className="relative col-span-1 row-span-4 rounded-xl bg-blue-100 shadow-md p-6">
      ...
      <div className="grid grid-rows-1 grid-cols-4 col-span-2 row-span-1 border border-white/50 rounded-xl shadow-md">
      ...
      <div className="relative bg-blue-500 col-span-1 row-span-2 rounded-xl shadow-md p-6">
      ...
      <div className="relative bg-gradient-to-br from-green-100 via-yellow-100 to-pink-100 col-span-2 row-span-3 rounded-xl shadow-lg p-8">
      ...
      {/* Bloque de análisis */}
      <div className="relative col-span-1 row-span-4 bg-blue-100 rounded-xl shadow-md p-6">
        <LineChart className="w-8 h-8 text-blue-600 mb-3" />
      ...
      <div className="relative col-span-1 row-span-2 bg-blue-500 rounded-xl shadow-md p-6">
      ...
      <div className="relative col-span-2 row-span-2 bg-green-400 rounded-xl shadow-md p-6 text-white">

      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid gap-12 md:grid-cols-3">
          ...
          >
            ...
            <h3 className="text-[#2B7EB6] text-2xl font-bold mb-4">Activá</h3>
          ...
          >
            ...
            <h3 className="text-[#2B7EB6] text-2xl font-bold mb-4">Impulsá</h3>
            <p className="text-white">
          ...
          >
            ...
            <h3 className="text-[#2B7EB6] text-2xl font-bold mb-4">Conectá</h3>
            <p className="text-white">

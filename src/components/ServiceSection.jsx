  ...
  return (
    <section className="bg-black py-32" id="serviciosSection">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-3xl font-bold text-[#4AD4B9] mb-4"></h1>
        <div className="grid gap-12 md:grid-cols-3">
          ...
          >
            ...
            <h2 className="text-[#2B7EB6] text-2xl font-bold mb-4">Activá</h2>
          ...
          >
            ...
            <h2 className="text-[#2B7EB6] text-2xl font-bold mb-4">Impulsá</h2>
            <p className="text-white">
          ...
          >
            ...
            <h2 className="text-[#2B7EB6] text-2xl font-bold mb-4">Conectá</h2>
            <p className="text-white">
